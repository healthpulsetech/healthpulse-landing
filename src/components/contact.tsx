...
const ContactUs = () => {
  ...
  return (
    <section id="contactus" className="scroll-mt-20">
      <div className="bg-background flex items-center justify-center p-4 font-poppins">
            ...
            <div className="w-full lg:w-3/5 p-8">
              <div className="max-w-sm mx-auto lg:max-w-none">
                ...
                <div className="space-y-5">
                  {/* Names */}
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-2">Names</label>
                  ...
                  {/* Request Type */}
                  <div>
                    <label htmlFor="requestType" className="block text-xs font-medium text-gray-700 mb-2">
                      How can we help?
                    </label>
                    <select
                      id="requestType"
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-secondary hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
            ...
            <div className="hidden lg:block lg:w-2/5 bg-secondary text-white p-6 flex flex-col justify-center">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-medium text-sm">Learn more about our product</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-white bg-opacity-20 rounded-lg flex-shrink-0">
                    <BookText className="w-4 h-4 text-secondary" />
                  </div>
                  <p className="font-medium text-sm">Check out our support center</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-white bg-opacity-20 rounded-lg flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-sm">We are growing fast! Interested in working with us?</p>
                    <p className="text-blue-100 mt-1 text-xs">team@healthpulse.africa</p>
                  </div>
                </div>
              </div>
            </div>
